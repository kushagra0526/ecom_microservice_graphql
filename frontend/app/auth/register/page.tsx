...
export default function RegisterPage() {
    ...
    // Client-side validation matching backend Joi schema exactly:
    // username: min 2, max 50 | email: valid format | password: min 6
            ...
            <div className="w-full max-w-md">
                ...
                <div className="rounded-xl p-8" style={{ background: 'white', border: '1px solid var(--wire)' }}>
                    ...
                    <p className="text-sm mb-6" style={{ color: 'var(--slate)' }}>
                        Already have one?{' '}
                        <Link href="/auth/login" style={{ color: 'var(--signal)' }}>
                            Log in
                        </Link>
                    </p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        {/* Role toggle — shown first so user picks intent before filling details */}
                        <div>
                            <label className="block text-xs font-medium mb-2" style={{ color: 'var(--slate)' }}>
                                I want to
                            </label>
                                ...
                                {(['buyer', 'seller'] as const).map((r) => (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            border: role === r ? '1px solid var(--signal)' : '1px solid var(--wire)',
                                        }}
                                    >
